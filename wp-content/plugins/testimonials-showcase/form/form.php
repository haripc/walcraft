		...
		$form_html .= '
			...
			if($tt_ajax) {
				...
				if($rating_on == 'hover') {
					...
					while ($maxrating > 1) {
						$rating_form_html .= '<input type="radio" '.checked( $tt_curr_selected, $maxrating, false ).' name="_aditional_info_rating" id="_aditional_info_rating_'.$maxrating.'" value="'.$maxrating.'" /><label for="_aditional_info_rating_'.$maxrating.'" title="'.$maxrating.' '.$tt_star_label_plural.'"><i class="fa fa-star"></i></label>';
						$maxrating--;
					}
				...
				if($boolean_field == 'radio') {
					...
					$yesno_form_html .= '<fieldset><label for="_aditional_info_custom_boolean">
				...
				if($boolean_field_2 == 'radio') {
					...
					$yesno_2_form_html .= '<fieldset><label for="_aditional_info_custom_boolean_2">
				...
				if($boolean_field_3 == 'radio') {
					...
					$yesno_3_form_html .= '<fieldset><label for="_aditional_info_custom_boolean_3">
				...
				if($boolean_field_4 == 'radio') {
					...
					$yesno_4_form_html .= '<fieldset><label for="_aditional_info_custom_boolean_4">
